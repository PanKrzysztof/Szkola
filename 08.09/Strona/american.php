...
<body>
    ...
    <section class="glowny">
        <img src="IMG/american.jpg" alt="Świnka morska rasy american">
        <?php
            include "DB/dbconnect.php";
            $connect = mysqli_connect($host, $dblogin, $dbpassword,$dbname);
            $query = "SELECT data_ur, miot, rasa FROM swinki JOIN rasy ON rasy_id=rasy.id WHERE rasy.id=6 GROUP BY miot;";
